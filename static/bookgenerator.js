...
document.getElementById('generate').onclick = function() {
    nilam_name = "* & !";
    nilam_name = nilam_name.replace('*', 'The');
    ...
    nilam_name = nilam_name.replace("&", UpperCaseFirstChar(RandomChoice(adjectives)))
    nilam_name = nilam_name.replace("!", RandomChoice(animals))

    document.getElementById('name').innerHTML = nilam_name

    document.getElementById('author').innerHTML = RandomChoice(names)


    var publishers = ["Quality Books", "GoodBooks", "KidBooks"]
    ...
    document.getElementById('publish_time').innerHTML = RandomChoice(nums)
}
